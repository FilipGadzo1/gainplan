...
export const INGREDIENT_LIST: Ingredient[] = [
  // ── Kött & Chark ─────────────────────────────────────────────────────────
  { id: 'kycklingfile', name: 'Kycklingfilé', en: 'Chicken breast', dept: 'meat', kcal: 106, protein: 22.5, carbs: 0, fat: 1.7, pricePerKg: 109, packSize: 700, packName: 'pack ca 700 g', packNameEn: 'pack approx 700 g', tags: ['meat'] },
  { id: 'kycklinglar', name: 'Kycklinglårfilé', en: 'Chicken thigh fillet', dept: 'meat', kcal: 150, protein: 19, carbs: 0, fat: 8, pricePerKg: 89, packSize: 800, packName: 'pack ca 800 g', packNameEn: 'pack approx 800 g', tags: ['meat'] },
  { id: 'kalkonfile', name: 'Kalkonfilé', en: 'Turkey breast', dept: 'meat', kcal: 105, protein: 23, carbs: 0.5, fat: 1, pricePerKg: 200, packSize: 400, packName: 'pack 400 g', packNameEn: 'pack 400 g', tags: ['meat'] },
  ...
  { id: 'flaskfile', name: 'Fläskfilé', en: 'Pork tenderloin', dept: 'meat', kcal: 112, protein: 21, carbs: 0, fat: 3, pricePerKg: 129, packSize: 500, packName: 'pack ca 500 g', packNameEn: 'pack approx 500 g', tags: ['meat', 'pork'] },
  ...
  // ── Fisk ─────────────────────────────────────────────────────────────────
  { id: 'lax', name: 'Laxfilé', en: 'Salmon fillet', dept: 'fish', kcal: 208, protein: 20, carbs: 0, fat: 13, pricePerKg: 219, packSize: 500, packName: 'pack ca 500 g', packNameEn: 'pack approx 500 g', tags: ['fish'] },
  { id: 'torsk', name: 'Torskfilé', en: 'Cod fillet', dept: 'fish', kcal: 82, protein: 18, carbs: 0, fat: 0.7, pricePerKg: 169, packSize: 400, packName: 'pack 400 g', packNameEn: 'pack 400 g', tags: ['fish'] },
  ...
  { id: 'broccoli', name: 'Broccoli', en: 'Broccoli', dept: 'produce', kcal: 34, protein: 2.8, carbs: 4, fat: 0.4, pricePerKg: 45, packSize: 500, packName: 'ca 500 g', packNameEn: 'approx 500 g', tags: [] },
  { id: 'blomkal', name: 'Blomkål', en: 'Cauliflower', dept: 'produce', kcal: 25, protein: 1.9, carbs: 3, fat: 0.3, pricePerKg: 39, packSize: 600, packName: '1 huvud ca 600 g', packNameEn: '1 head approx 600 g', tags: [] },
  ...
  { id: 'morot', name: 'Morötter', en: 'Carrots', dept: 'produce', kcal: 41, protein: 0.9, carbs: 8, fat: 0.2, pricePerKg: 20, packSize: 1000, packName: 'påse 1 kg', packNameEn: 'bag 1 kg', tags: [] },
  { id: 'potatis', name: 'Fast potatis', en: 'Potatoes', dept: 'produce', kcal: 77, protein: 2, carbs: 16, fat: 0.1, pricePerKg: 18, packSize: 2000, packName: 'påse 2 kg', packNameEn: 'bag 2 kg', tags: [] },
  { id: 'sotpotatis', name: 'Sötpotatis', en: 'Sweet potato', dept: 'produce', kcal: 86, protein: 1.6, carbs: 18, fat: 0.1, pricePerKg: 40, packSize: 1000, packName: 'lösvikt', packNameEn: 'loose', tags: [] },
  ...
  { id: 'korsbarstomat', name: 'Körsbärstomater', en: 'Cherry tomatoes', dept: 'produce', kcal: 30, protein: 0.9, carbs: 4, fat: 0.3, pricePerKg: 80, packSize: 250, packName: 'ask 250 g', packNameEn: 'punnet 250 g', tags: [] },
  { id: 'gurka', name: 'Gurka', en: 'Cucumber', dept: 'produce', kcal: 15, protein: 0.7, carbs: 2, fat: 0.1, pricePerKg: 30, packSize: 400, packName: '1 st', packNameEn: '1 pc', tags: [] },
  ...
  { id: 'champinjon', name: 'Champinjoner', en: 'Mushrooms', dept: 'produce', kcal: 22, protein: 3.1, carbs: 0.3, fat: 0.3, pricePerKg: 60, packSize: 250, packName: 'ask 250 g', packNameEn: 'punnet 250 g', tags: [] },
  { id: 'zucchini', name: 'Zucchini', en: 'Courgette', dept: 'produce', kcal: 17, protein: 1.2, carbs: 2, fat: 0.3, pricePerKg: 45, packSize: 400, packName: '1 st', packNameEn: '1 pc', tags: [] },
 ...
 * UAE rows an `ae-` prefix), and a shared lookup keeps `getIngredient` out of
 * the business of knowing who is asking. Which subset a plan may draw from is
 * the region's job, not this table's — see `eligibleRecipes`.
 */
