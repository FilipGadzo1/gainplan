...
const RAW: Ingredient[] = [
  ...
  { id: 'notfars5', name: 'Nötfärs 5%', en: 'Lean beef mince 5%', dept: 'Kött & Chark', kcal: 130, protein: 21, carbs: 0, fat: 5, pricePerKg: 139, packSize: 500, packName: 'pack 500 g', packNameEn: 'pack 500 g', icaQuery: 'nötfärs', tags: ['meat'] },
  { id: 'notfars10', name: 'Nötfärs 10%', en: 'Beef mince 10%', dept: 'Kött & Chark', kcal: 176, protein: 19, carbs: 0, fat: 11, pricePerKg: 105, packSize: 500, packName: 'pack 500 g', packNameEn: 'pack 500 g', icaQuery: 'nötfärs', tags: ['meat'] },
  ...
  { id: 'aggvita', name: 'Äggvita, flytande', en: 'Liquid egg whites', dept: 'Mejeri & Ägg', kcal: 48, protein: 11, carbs: 0.7, fat: 0, pricePerKg: 89, packSize: 500, packName: 'förp 500 g', packNameEn: 'pack 500 g', icaQuery: 'äggvita', tags: ['egg'] },
  { id: 'kvarg', name: 'Kvarg naturell 0,2%', en: 'Quark, plain', dept: 'Mejeri & Ägg', kcal: 62, protein: 11, carbs: 4, fat: 0.2, pricePerKg: 55, packSize: 500, packName: 'förp 500 g', packNameEn: 'pack 500 g', icaQuery: 'kvarg naturell', tags: ['dairy', 'lactose'] },
  { id: 'keso', name: 'Keso 4%', en: 'Cottage cheese', dept: 'Mejeri & Ägg', kcal: 79, protein: 12, carbs: 2.5, fat: 2, pricePerKg: 60, packSize: 500, packName: 'förp 500 g', packNameEn: 'pack 500 g', icaQuery: 'keso', tags: ['dairy', 'lactose'] },
  { id: 'grekyoghurt', name: 'Grekisk yoghurt 2%', en: 'Greek yoghurt 2%', dept: 'Mejeri & Ägg', kcal: 73, protein: 9, carbs: 4, fat: 2, pricePerKg: 55, packSize: 1000, packName: 'förp 1 kg', packNameEn: 'tub 1 kg', icaQuery: 'grekisk yoghurt', tags: ['dairy', 'lactose'] },
  ...
  { id: 'mjolk', name: 'Mellanmjölk 1,5%', en: 'Milk 1.5%', dept: 'Mejeri & Ägg', kcal: 45, protein: 3.5, carbs: 5, fat: 1.5, pricePerKg: 16, packSize: 1000, packName: 'förp 1 l', packNameEn: 'carton 1 l', icaQuery: 'mellanmjölk', tags: ['dairy', 'lactose'] },
  { id: 'rivenost', name: 'Riven ost 17%', en: 'Grated cheese', dept: 'Mejeri & Ägg', kcal: 265, protein: 30, carbs: 1, fat: 17, pricePerKg: 119, packSize: 250, packName: 'påse 250 g', packNameEn: 'bag 250 g', icaQuery: 'riven ost', tags: ['dairy'] },
  ...
  { id: 'parmesan', name: 'Parmesan, riven', en: 'Parmesan', dept: 'Mejeri & Ägg', kcal: 400, protein: 32, carbs: 0, fat: 30, pricePerKg: 249, packSize: 150, packName: 'förp 150 g', packNameEn: 'pack 150 g', icaQuery: 'parmesan riven', tags: ['dairy'] },
  ...
  { id: 'cremefraiche', name: 'Crème fraiche lätt', en: 'Light crème fraîche', dept: 'Mejeri & Ägg', kcal: 130, protein: 3, carbs: 4, fat: 11, pricePerKg: 60, packSize: 200, packName: 'förp 2 dl', packNameEn: 'tub 200 ml', icaQuery: 'crème fraiche', tags: ['dairy', 'lactose'] },
  ...
  { id: 'orter', name: 'Färska örter', en: 'Fresh herbs', dept: 'Frukt & Grönt', kcal: 40, protein: 3, carbs: 2, fat: 0.5, pricePerKg: 240, packSize: 25, packName: 'kruka/påse', packNameEn: 'pot/bag', icaQuery: 'färska örter', tags: [] },
  ...
  { id: 'tortilla', name: 'Tortillabröd fullkorn', en: 'Wholegrain tortilla', dept: 'Bröd', kcal: 290, protein: 9, carbs: 46, fat: 6, pricePerKg: 90, packSize: 320, packName: 'förp 8 st', packNameEn: 'pack of 8', unitWeight: 40, icaQuery: 'tortillabröd', tags: ['gluten'] },
  ...
  { id: 'kikartor', name: 'Kikärtor, konserv', en: 'Chickpeas, canned', dept: 'Skafferi', kcal: 120, protein: 7, carbs: 15, fat: 2.6, pricePerKg: 32, packSize: 380, packName: 'burk 380 g avrunnen', packNameEn: 'tin 380 g drained', icaQuery: 'kikärtor', tags: [] },
  { id: 'svartabonor', name: 'Svarta bönor, konserv', en: 'Black beans, canned', dept: 'Skafferi', kcal: 110, protein: 7, carbs: 14, fat: 0.6, pricePerKg: 32, packSize: 380, packName: 'burk 380 g avrunnen', packNameEn: 'tin 380 g drained', icaQuery: 'svarta bönor', tags: [] },
  ...
  { id: 'granola', name: 'Musli utan tillsatt socker', en: 'No-added-sugar muesli', dept: 'Skafferi', kcal: 420, protein: 9, carbs: 60, fat: 14, pricePerKg: 80, packSize: 750, packName: 'påse 750 g', packNameEn: 'bag 750 g', icaQuery: 'musli', tags: ['gluten', 'nuts'] },
  ...
  { id: 'majs', name: 'Majs, konserv', en: 'Sweetcorn, canned', dept: 'Skafferi', kcal: 90, protein: 3, carbs: 15, fat: 1, pricePerKg: 40, packSize: 340, packName: 'burk 340 g', packNameEn: 'tin 340 g', icaQuery: 'majs konserv', tags: [] },
  ...
  { id: 'kryddor', name: 'Kryddor (salt, peppar, paprika, spiskummin)', en: 'Spices', dept: 'Skafferi', kcal: 300, protein: 10, carbs: 50, fat: 5, pricePerKg: 300, packSize: 100, packName: 'burkar', packNameEn: 'tins', staple: true, icaQuery: 'kryddor', tags: [] },
  ...
  { id: 'wokgronsaker', name: 'Wokgrönsaker, frysta', en: 'Frozen stir-fry vegetables', dept: 'Fryst', kcal: 40, protein: 2, carbs: 5, fat: 0.5, pricePerKg: 40, packSize: 500, packName: 'påse 500 g', packNameEn: 'bag 500 g', icaQuery: 'wokgrönsaker', tags: [] },
  ...
  { id: 'sojafars', name: 'Sojafärs, fryst', en: 'Soy mince, frozen', dept: 'Fryst', kcal: 105, protein: 15, carbs: 5, fat: 2, pricePerKg: 120, packSize: 400, packName: 'påse 400 g', packNameEn: 'bag 400 g', icaQuery: 'sojafärs', tags: ['soy'] },
];
