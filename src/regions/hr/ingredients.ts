...
export const HR_INGREDIENTS: Ingredient[] = [
  ...
  { id: 'hr-spinat', name: 'Mladi špinat', en: 'Baby spinach', dept: 'produce', kcal: 23, protein: 2.9, carbs: 1, fat: 0.4, pricePerKg: 8, packSize: 200, packName: 'pak. 200 g', packNameEn: 'bag 200 g', storeQuery: 'špinat', tags: [] },
  ...
  { id: 'hr-zacinsko-bilje', name: 'Svježe začinsko bilje', en: 'Fresh herbs', dept: 'produce', kcal: 40, protein: 3, carbs: 2, fat: 0.5, pricePerKg: 18, packSize: 25, packName: 'lončić/vrećica', packNameEn: 'pot/bag', storeQuery: 'peršin', tags: [] },
  ...
  { id: 'hr-pileci-zabaci', name: 'Pileći zabaci bez kosti', en: 'Chicken thigh fillet', dept: 'meat', kcal: 150, protein: 19, carbs: 0, fat: 8, pricePerKg: 5.9, packSize: 800, packName: 'pak. cca 800 g', packNameEn: 'pack approx 800 g', storeQuery: 'pileći zabatak', tags: ['meat'] },
  ...
  { id: 'hr-junece-mljeveno', name: 'Juneće mljeveno meso', en: 'Lean beef mince 5%', dept: 'meat', kcal: 130, protein: 21, carbs: 0, fat: 5, pricePerKg: 10.5, packSize: 500, packName: 'pak. 500 g', packNameEn: 'pack 500 g', storeQuery: 'mljeveno meso', tags: ['meat'] },
  { id: 'hr-mjesano-mljeveno', name: 'Miješano mljeveno meso', en: 'Beef mince 10%', dept: 'meat', kcal: 176, protein: 19, carbs: 0, fat: 11, pricePerKg: 7.9, packSize: 500, packName: 'pak. 500 g', packNameEn: 'pack 500 g', storeQuery: 'mljeveno meso', tags: ['meat'] },
  { id: 'hr-svinjski-file', name: 'Svinjski file', en: 'Pork tenderloin', dept: 'meat', kcal: 112, protein: 21, carbs: 0, fat: 3, pricePerKg: 8.9, packSize: 500, packName: 'pak. cca 500 g', packNameEn: 'pack approx 500 g', storeQuery: 'svinjetina', tags: ['meat', 'pork'] },
  ...
  { id: 'hr-bjelanjci', name: 'Tekući bjelanjci', en: 'Liquid egg whites', dept: 'dairy', kcal: 48, protein: 11, carbs: 0.7, fat: 0, pricePerKg: 7.5, packSize: 500, packName: 'pak. 500 g', packNameEn: 'pack 500 g', storeQuery: 'jaja', tags: ['egg'] },
  ...
  { id: 'hr-halloumi', name: 'Halloumi', en: 'Halloumi', dept: 'dairy', kcal: 320, protein: 22, carbs: 2, fat: 25, pricePerKg: 16, packSize: 225, packName: 'pak. 225 g', packNameEn: 'pack 250 g', storeQuery: 'sir za pečenje', tags: ['dairy'] },
  { id: 'hr-vrhnje', name: 'Kiselo vrhnje lagano', en: 'Light crème fraîche', dept: 'dairy', kcal: 130, protein: 3, carbs: 4, fat: 11, pricePerKg: 4.5, packSize: 200, packName: 'pak. 200 g', packNameEn: 'tub 200 ml', storeQuery: 'kiselo vrhnje', tags: ['dairy', 'lactose'] },
  ...
  { id: 'hr-tofu', name: 'Tofu natur', en: 'Firm tofu', dept: 'dairy', kcal: 130, protein: 14, carbs: 2, fat: 7, pricePerKg: 9, packSize: 400, packName: 'pak. 400 g', packNameEn: 'pack 400 g', storeQuery: 'tofu', tags: ['soy'] },
  ...
  { id: 'hr-prepecenac', name: 'Integralni prepečenac', en: 'Crispbread', dept: 'bread', kcal: 350, protein: 10, carbs: 60, fat: 3, pricePerKg: 5, packSize: 250, packName: 'pak. 250 g', packNameEn: 'pack 250 g', unitWeight: 12, storeQuery: 'dvopek', tags: ['gluten'] },
  { id: 'hr-tortilja', name: 'Integralne tortilje', en: 'Wholegrain tortilla', dept: 'bread', kcal: 290, protein: 9, carbs: 46, fat: 6, pricePerKg: 6, packSize: 320, packName: 'pak. 320 g', packNameEn: 'pack of 8', unitWeight: 40, storeQuery: 'tortilja', tags: ['gluten'] },

  // ── Smrznuto ────────────────────────────────────────────────────────────
  { id: 'hr-borovnice', name: 'Smrznute borovnice', en: 'Frozen blueberries', dept: 'frozen', kcal: 45, protein: 0.7, carbs: 8, fat: 0.4, pricePerKg: 7, packSize: 450, packName: 'vreća 450 g', packNameEn: 'bag 500 g', storeQuery: 'borovnice', tags: [] },
  ...
  { id: 'hr-wok-povrce', name: 'Smrznuto wok povrće', en: 'Frozen stir-fry vegetables', dept: 'frozen', kcal: 40, protein: 2, carbs: 5, fat: 0.5, pricePerKg: 3.2, packSize: 450, packName: 'vreća 450 g', packNameEn: 'bag 500 g', storeQuery: 'wok povrće', tags: [] },
  { id: 'hr-sojino-mljeveno', name: 'Sojino mljeveno, smrznuto', en: 'Soy mince, frozen', dept: 'frozen', kcal: 105, protein: 15, carbs: 5, fat: 2, pricePerKg: 8, packSize: 400, packName: 'vreća 400 g', packNameEn: 'bag 400 g', storeQuery: 'soja', tags: ['soy'] },

  // ── Trajni proizvodi ────────────────────────────────────────────────────
  { id: 'hr-tuna', name: 'Tuna u vodi', en: 'Canned tuna in water', dept: 'pantry', kcal: 100, protein: 23, carbs: 0, fat: 1, pricePerKg: 11, packSize: 140, packName: 'konz. 185 g (140 g ocijeđeno)', packNameEn: 'tin 185 g (140 g drained)', storeQuery: 'tuna', tags: ['fish'] },
  { id: 'hr-skusa', name: 'Skuša u umaku od rajčice', en: 'Mackerel in tomato sauce', dept: 'pantry', kcal: 190, protein: 15, carbs: 4, fat: 12, pricePerKg: 6.5, packSize: 375, packName: 'konz. 375 g', packNameEn: 'tin 375 g', storeQuery: 'skuša', tags: ['fish'] },
  ...
  { id: 'hr-slanutak', name: 'Slanutak, konzerva', en: 'Chickpeas, canned', dept: 'pantry', kcal: 120, protein: 7, carbs: 15, fat: 2.6, pricePerKg: 3, packSize: 400, packName: 'konz. 400 g', packNameEn: 'tin 380 g drained', storeQuery: 'slanutak', tags: [] },
  { id: 'hr-crni-grah', name: 'Crni grah, konzerva', en: 'Black beans, canned', dept: 'pantry', kcal: 110, protein: 7, carbs: 14, fat: 0.6, pricePerKg: 3, packSize: 400, packName: 'konz. 400 g', packNameEn: 'tin 380 g drained', storeQuery: 'grah', tags: [] },
  ...
  { id: 'hr-musli', name: 'Musli bez dodanog šećera', en: 'No-added-sugar muesli', dept: 'pantry', kcal: 420, protein: 9, carbs: 60, fat: 14, pricePerKg: 5.5, packSize: 500, packName: 'pak. 500 g', packNameEn: 'bag 750 g', storeQuery: 'musli', tags: ['gluten', 'nuts'] },
  ...
  { id: 'hr-kukuruz', name: 'Kukuruz šećerac, konzerva', en: 'Sweetcorn, canned', dept: 'pantry', kcal: 90, protein: 3, carbs: 15, fat: 1, pricePerKg: 3.5, packSize: 340, packName: 'konz. 340 g', packNameEn: 'tin 340 g', storeQuery: 'kukuruz', tags: [] },
  ...
  { id: 'hr-sriracha', name: 'Sriracha umak', en: 'Sriracha', dept: 'pantry', kcal: 100, protein: 1, carbs: 20, fat: 0.5, pricePerKg: 11, packSize: 200, packName: 'boca 200 ml', packNameEn: 'bottle 200 ml', staple: true, storeQuery: 'ljuti umak', tags: [] },
  { id: 'hr-senf', name: 'Dijon senf', en: 'Dijon mustard', dept: 'pantry', kcal: 150, protein: 6, carbs: 5, fat: 10, pricePerKg: 8, packSize: 200, packName: 'staklenka 200 g', packNameEn: 'tin 200 g', staple: true, storeQuery: 'senf', tags: [] },
  { id: 'hr-temeljac', name: 'Kocke za temeljac', en: 'Stock cubes', dept: 'pantry', kcal: 200, protein: 10, carbs: 20, fat: 10, pricePerKg: 15, packSize: 60, packName: 'pak. 60 g', packNameEn: 'pack of 8', staple: true, storeQuery: 'temeljac', tags: [] },
  { id: 'hr-zacini', name: 'Začini (sol, papar, paprika, kim)', en: 'Spices', dept: 'pantry', kcal: 300, protein: 10, carbs: 50, fat: 5, pricePerKg: 25, packSize: 100, packName: 'vrećice', packNameEn: 'tins', staple: true, storeQuery: 'začini', tags: [] },
];
