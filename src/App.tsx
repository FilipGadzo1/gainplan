...
export default function App() {
  ...
  const [hasOnboarded, setHasOnboarded] = useState(() => loadProfile() !== null);
  ...
  const [tab, setTab] = useState<Tab>(() => (loadPlan() ? 'week' : 'setup'));
  ...
  return (
    ...
    // overflow, so the week can lay itself out to fit instead of running off the
    // bottom of the page. Mobile keeps ordinary page scrolling.
